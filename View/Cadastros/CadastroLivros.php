   ...
   <header>
    ...
    <div class="container-body">
      <div class="container-form">
               ...
               <p class="title"> Cadastrar Livro </p>
                ...
                <div class="row">
                  ...
                  <div class="col">
                     ...
                     <input type="text" name="generoLivro" class="input-form" placeholder="Gênero do Livro" list="generos" required>
                  </div>
               </div>
               <div class="row">
                  <div class="col">
         ...
         <a href="https://sibigerardojose.000webhostapp.com/View/Livros/TelaLivros.php?busca=&menuCategorias=Todos" class="btn-exit"> <img id="exitIcon" src="assets/exit-icon.png" alt="exitIcon"></i>Sair </a>
      </div>
   </div>
